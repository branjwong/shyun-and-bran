...
var _user$project$Model$Preferences = F2(
	function (a, b) {
		return {shopping: a, sightseeing: b};
	});
...
var _user$project$Model$LookAtUser = function (a) {
	return {ctor: 'LookAtUser', _0: a};
};
var _user$project$Model$AddPreference = F2(
	function (a, b) {
		return {ctor: 'AddPreference', _0: a, _1: b};
	});
var _user$project$Model$NavbarMsg = function (a) {
	return {ctor: 'NavbarMsg', _0: a};
};
var _user$project$Model$Goto = function (a) {
	return {ctor: 'Goto', _0: a};
};
var _user$project$Model$NoOp = {ctor: 'NoOp'};
var _user$project$Model$Matcher = {ctor: 'Matcher'};
var _user$project$Model$PreferencesSightseeing = {ctor: 'PreferencesSightseeing'};
var _user$project$Model$PreferencesShopping = {ctor: 'PreferencesShopping'};
var _user$project$Model$PreferencesRoot = {ctor: 'PreferencesRoot'};
var _user$project$Model$MainMenu = {ctor: 'MainMenu'};
var _user$project$Model$Login = {ctor: 'Login'};
var _user$project$Model$blankModel = function () {
	var _p0 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Model$NavbarMsg);
	var state = _p0._0;
	var cmd = _p0._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			page: _user$project$Model$Login,
			navbarState: state,
			preferences: {
				shopping: {ctor: '[]'},
				sightseeing: {ctor: '[]'}
...
var _user$project$Model$Sightseeing = {ctor: 'Sightseeing'};
var _user$project$Model$Shopping = {ctor: 'Shopping'};

var _user$project$DevSettings$testRightMatches = {
	ctor: '::',
	_0: {
...
var _user$project$DevSettings$devModel = function () {
	var _p0 = _user$project$Model$blankModel;
	var model = _p0._0;
	var cmd = _p0._1;
	...
	return A2(
		...
		_elm_lang$core$Native_Utils.update(
			model,
			{page: _user$project$Model$Login, rightMatches: _user$project$DevSettings$testRightMatches}),
		{
			ctor: '::',
			_0: cmd,
			_1: {ctor: '[]'}
...
var _user$project$Update$updateModel = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'AddPreference':
				...
				var preferences = model.preferences;
				var _p1 = _p0._0;
				if (_p1.ctor === 'Shopping') {
					var _p2 = A2(_elm_lang$core$List$member, _p4, model.preferences.shopping);
					if (_p2 === true) {
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								preferences: _elm_lang$core$Native_Utils.update(
									preferences,
									{
										shopping: A2(
											...
											function (str) {
												return !_elm_lang$core$Native_Utils.eq(str, _p4);
											},
											model.preferences.shopping)
									})
							});
					} else {
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								preferences: _elm_lang$core$Native_Utils.update(
									preferences,
									{
										shopping: {ctor: '::', _0: _p4, _1: model.preferences.shopping}
									})
							});
					}
				} else {
					var _p3 = A2(_elm_lang$core$List$member, _p4, model.preferences.sightseeing);
					if (_p3 === true) {
						return _elm_lang$core$Native_Utils.update(
							model,
							{
						...
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								preferences: _elm_lang$core$Native_Utils.update(
									preferences,
									{
										sightseeing: {ctor: '::', _0: _p4, _1: model.preferences.sightseeing}
									})
							});
					}
				}
			case 'LookAtUser':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						userBeingViewed: _elm_lang$core$Maybe$Just(_p0._0)
					});
			case 'LookAwayFromUser':
				return _elm_lang$core$Native_Utils.update(
					model,
					{userBeingViewed: _elm_lang$core$Maybe$Nothing});
			default:
				...
				if (_p5.ctor === 'Right') {
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							rightMatches: A2(_elm_lang$core$List$drop, 1, model.rightMatches),
							leftMatches: function () {
								var _p6 = _elm_lang$core$List$head(model.rightMatches);
								if (_p6.ctor === 'Just') {
									return {ctor: '::', _0: _p6._0, _1: model.leftMatches};
								} else {
									return model.leftMatches;
								}
							}(),
							userBeingViewed: _elm_lang$core$Maybe$Nothing
						});
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							leftMatches: A2(_elm_lang$core$List$drop, 1, model.leftMatches),
							rightMatches: function () {
								var _p7 = _elm_lang$core$List$head(model.leftMatches);
								if (_p7.ctor === 'Just') {
									return {ctor: '::', _0: _p7._0, _1: model.rightMatches};
								} else {
									return model.rightMatches;
								}
							}(),
							userBeingViewed: _elm_lang$core$Maybe$Nothing
						});
...
var _user$project$Update$update = F2(
	function (msg, model) {
		var _p8 = msg;
		if (_p8.ctor === 'Goto') {
			var _p9 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Model$NavbarMsg);
			var state = _p9._0;
			var cmd = _p9._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
			...
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				A2(_user$project$Update$updateModel, msg, model),
				{
					ctor: '::',
...
var _user$project$SharedStyles$FadeClass = {ctor: 'FadeClass'};
var _user$project$SharedStyles$FinderInfo = {ctor: 'FinderInfo'};
var _user$project$SharedStyles$FinderFace = {ctor: 'FinderFace'};
var _user$project$SharedStyles$FinderFigure = {ctor: 'FinderFigure'};
var _user$project$SharedStyles$FinderNavigationSideBar = {ctor: 'FinderNavigationSideBar'};
var _user$project$SharedStyles$FinderBody = {ctor: 'FinderBody'};
var _user$project$SharedStyles$BlockDiv = {ctor: 'BlockDiv'};
var _user$project$SharedStyles$BlockRimSelected = {ctor: 'BlockRimSelected'};
var _user$project$SharedStyles$BlockRim = {ctor: 'BlockRim'};
var _user$project$SharedStyles$Block = {ctor: 'Block'};
var _user$project$SharedStyles$SignInHeading = {ctor: 'SignInHeading'};
var _user$project$SharedStyles$FormControl = {ctor: 'FormControl'};
var _user$project$SharedStyles$FormSignInHeading = {ctor: 'FormSignInHeading'};
var _user$project$SharedStyles$FormSignIn = {ctor: 'FormSignIn'};
var _user$project$SharedStyles$Navbar = {ctor: 'Navbar'};
var _user$project$SharedStyles$InputPassword = {ctor: 'InputPassword'};
var _user$project$SharedStyles$InputEmail = {ctor: 'InputEmail'};

var _user$project$Login$_p0 = _user$project$SharedStyles$loginNamespace;
var _user$project$Login$id = _user$project$Login$_p0.id;
var _user$project$Login$class = _user$project$Login$_p0.$class;
var _user$project$Login$classList = _user$project$Login$_p0.classList;
var _user$project$Login$view = A2(
	_rundis$elm_bootstrap$Bootstrap_Grid$container,
	{
		ctor: '::',
		_0: _user$project$Login$class(
			{
				ctor: '::',
				_0: _user$project$SharedStyles$FormSignIn,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
		...
		_0: A2(
			_elm_lang$html$Html$h2,
			{
				...
				_0: _user$project$Login$class(
					{
						ctor: '::',
						_0: _user$project$SharedStyles$SignInHeading,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(_user$project$Localization$getLocal, 'login', 'heading')),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('inputEmail'),
					_1: {
						ctor: '::',
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_user$project$Localization$getLocal, 'login', 'placeholder_email')),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_0: _user$project$Login$class(
								{
									ctor: '::',
									_0: _user$project$SharedStyles$FormControl,
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder(
										A2(_user$project$Localization$getLocal, 'login', 'placeholder_password')),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$required(true),
										_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Model$Goto(_user$project$Model$MainMenu)),
										_1: {ctor: '[]'}
									}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_user$project$Localization$getLocal, 'login', 'button')),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Utilities$sortPreferences = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p5 = _p2._0;
		var _p3 = _p0;
		var _p4 = _p3._0;
		var $default = 'Show Me Around';
		return _elm_lang$core$Native_Utils.eq(_p5, $default) ? _elm_lang$core$Basics$GT : (_elm_lang$core$Native_Utils.eq(_p4, $default) ? _elm_lang$core$Basics$LT : A2(_elm_lang$core$Basics$compare, _p5, _p4));
	});
var _user$project$Utilities$listToTupleList = F2(
	function (list, $default) {
		var _p6 = list;
		if (_p6.ctor === '[]') {
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: $default, _1: $default},
				_1: {ctor: '[]'}
			};
		} else {
			if (_p6._1.ctor === '[]') {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p6._0, _1: $default},
					_1: {ctor: '[]'}
				};
			} else {
				var _p8 = _p6._0;
				...
				if (_p7.ctor === '[]') {
					...
					if (_p7._1.ctor === '[]') {
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p8, _1: _p7._0},
							_1: {ctor: '[]'}
						};
					} else {
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p8, _1: _p7._0},
							_1: A2(_user$project$Utilities$listToTupleList, _p7._1, $default)
						};
					}
				}
			}
...
var _user$project$ViewUtilities$faIcon = function (iconName) {
	return A3(
		_elm_lang$html$Html$node,
		'i',
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(iconName),
			_1: {
				ctor: '::',
...
var _user$project$ViewUtilities$classList = _user$project$ViewUtilities$_p0.classList;
var _user$project$ViewUtilities$navbar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$ViewUtilities$class(
				{
					ctor: '::',
					...
					_rundis$elm_bootstrap$Bootstrap_Navbar$customItems,
					{
						...
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Navbar$textItem,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Model$Goto(_user$project$Model$Login)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_user$project$Localization$getLocal, 'navbar', 'logout')),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					A2(
						_rundis$elm_bootstrap$Bootstrap_Navbar$items,
						{
							...
							_0: A2(
								_rundis$elm_bootstrap$Bootstrap_Navbar$itemLink,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Model$Goto(_user$project$Model$PreferencesRoot)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(_user$project$Localization$getLocal, 'navbar', 'preferences')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_rundis$elm_bootstrap$Bootstrap_Navbar$itemLink,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Model$Goto(_user$project$Model$Matcher)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											A2(_user$project$Localization$getLocal, 'navbar', 'matcher')),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
						...
						A3(
							...
							_rundis$elm_bootstrap$Bootstrap_Navbar$withAnimation(
								_rundis$elm_bootstrap$Bootstrap_Navbar$config(_user$project$Model$NavbarMsg)))))),
			_1: {ctor: '[]'}
		});
};
var _user$project$ViewUtilities$gotoButton = F2(
	function (page, txt) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _user$project$ViewUtilities$block = F4(
	function (prefList, title, event, image) {
		var rimClass = function () {
			var _p1 = A2(_elm_lang$core$List$member, title, prefList);
			if (_p1 === true) {
				return _user$project$SharedStyles$BlockRimSelected;
			} else {
				return _user$project$SharedStyles$BlockRim;
			}
		}();
		return (!_elm_lang$core$Native_Utils.eq(title, '')) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$ViewUtilities$class(
					{
						ctor: '::',
						_0: _user$project$SharedStyles$BlockDiv,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(event),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _user$project$ViewUtilities$class(
									{
										ctor: '::',
										_0: _user$project$SharedStyles$Block,
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _user$project$ViewUtilities$blockRow = F4(
	function (prefList, _p4, _p3, _p2) {
		var _p5 = _p4;
		var _p6 = _p3;
		var _p7 = _p2;
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A4(_user$project$ViewUtilities$block, prefList, _p5._0, _p6._0, _p7._0),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A4(_user$project$ViewUtilities$block, prefList, _p5._1, _p6._1, _p7._1),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$ViewUtilities$blocks = F4(
	function (prefList, titles, msgs, images) {
		var image_ = A2(_user$project$Utilities$listToTupleList, images, '');
		var msgs_ = A2(_user$project$Utilities$listToTupleList, msgs, _user$project$Model$NoOp);
		var titles_ = A2(_user$project$Utilities$listToTupleList, titles, '');
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A4(
				_elm_lang$core$List$map3,
				_user$project$ViewUtilities$blockRow(prefList),
				titles_,
				msgs_,
				image_));
	});
...
var _user$project$MainMenu$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$ViewUtilities$navbar(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$h2,
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_user$project$Localization$getLocal, 'mainMenu', 'title')),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$ViewUtilities$gotoButton,
						_user$project$Model$PreferencesRoot,
						A2(_user$project$Localization$getLocal, 'navbar', 'preferences')),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$ViewUtilities$gotoButton,
							_user$project$Model$Matcher,
							A2(_user$project$Localization$getLocal, 'navbar', 'matcher')),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$ViewUtilities$gotoButton,
								_user$project$Model$Login,
								A2(_user$project$Localization$getLocal, 'navbar', 'logout')),
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Preferences_Root$view = function (model) {
	var gotoPage = function (item) {
		var _p0 = item;
		switch (_p0) {
			case 'Shopping':
				return _user$project$Model$Goto(_user$project$Model$PreferencesShopping);
			case 'Sightseeing':
				return _user$project$Model$Goto(_user$project$Model$PreferencesSightseeing);
			default:
	...
	var msgs = A2(_elm_lang$core$List$map, gotoPage, items);
	var images = A2(
		_elm_lang$core$List$map,
		function (_p1) {
			return '';
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Which searchables would you like to change?'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A4(
						_user$project$ViewUtilities$blocks,
						{ctor: '[]'},
						items,
						msgs,
						images),
...
var _user$project$Preferences_Shopping$view = function (model) {
	var itemImagePairs = A2(
		_elm_lang$core$List$sortWith,
		_user$project$Utilities$sortPreferences,
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Shibuya', _1: 'http://www.japan-guide.com/g2/3007_02.jpg'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Shinjuku', _1: ''},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Akihabara', _1: ''},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Ginza', _1: ''},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Tokyo Station', _1: ''},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Show Me Around', _1: ''},
								_1: {ctor: '[]'}
							}
						}
					}
	...
	var _p0 = _elm_lang$core$List$unzip(itemImagePairs);
	var items = _p0._0;
	var images = _p0._1;
	var msgs = A2(
		_elm_lang$core$List$map,
		_user$project$Model$AddPreference(_user$project$Model$Shopping),
		items);
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Shopping Searchables'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A4(_user$project$ViewUtilities$blocks, model.preferences.shopping, items, msgs, images),
					_1: {
						ctor: '::',
						_0: A2(_user$project$ViewUtilities$gotoButton, _user$project$Model$PreferencesRoot, 'Back to Searchables Select'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Preferences_Sightseeing$view = function (model) {
	var itemImagePairs = A2(
		_elm_lang$core$List$sortWith,
		_user$project$Utilities$sortPreferences,
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Sensoji', _1: ''},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Yokohama', _1: ''},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Akihabara', _1: ''},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Akihabara Electric City', _1: ''},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Ghibli Museum', _1: ''},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Show Me Around', _1: ''},
								_1: {ctor: '[]'}
	...
	var msgs = A2(
		_elm_lang$core$List$map,
		_user$project$Model$AddPreference(_user$project$Model$Sightseeing),
		items);
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Sightseeing Searchables'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A4(_user$project$ViewUtilities$blocks, model.preferences.sightseeing, items, msgs, images),
					_1: {
						ctor: '::',
						_0: A2(_user$project$ViewUtilities$gotoButton, _user$project$Model$PreferencesRoot, 'Back to Searchables Select'),
						_1: {ctor: '[]'}
...
var _user$project$Matcher_Finder$createPill = function (str) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('badge badge-pill badge-default'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Matcher_Finder$showInfos = function (user) {
	var sightseeing = A2(_elm_lang$core$List$map, _user$project$Matcher_Finder$createPill, user.preferences.sightseeing);
	var shopping = A2(_elm_lang$core$List$map, _user$project$Matcher_Finder$createPill, user.preferences.shopping);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A3(
...
var _user$project$Matcher_Finder$_p0 = _user$project$SharedStyles$loginNamespace;
var _user$project$Matcher_Finder$id = _user$project$Matcher_Finder$_p0.id;
var _user$project$Matcher_Finder$class = _user$project$Matcher_Finder$_p0.$class;
var _user$project$Matcher_Finder$classList = _user$project$Matcher_Finder$_p0.classList;
var _user$project$Matcher_Finder$localProfile = function (model) {
	var arrow = F2(
		function (model, direction) {
			var arrowClass = (_elm_lang$core$Native_Utils.eq(direction, _user$project$Model$Left) && _elm_lang$core$List$isEmpty(model.leftMatches)) ? {
				ctor: '::',
				_0: _user$project$SharedStyles$FadeClass,
				_1: {ctor: '[]'}
			} : ((_elm_lang$core$Native_Utils.eq(direction, _user$project$Model$Right) && (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(model.rightMatches),
				1) < 1)) ? {
				ctor: '::',
				_0: _user$project$SharedStyles$FadeClass,
				_1: {ctor: '[]'}
			} : {ctor: '[]'});
			var event = (_elm_lang$core$Native_Utils.eq(direction, _user$project$Model$Left) && _elm_lang$core$List$isEmpty(model.leftMatches)) ? _user$project$Model$NoOp : ((_elm_lang$core$Native_Utils.eq(direction, _user$project$Model$Right) && (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(model.rightMatches),
				1) < 1)) ? _user$project$Model$NoOp : _user$project$Model$Look(direction));
			var faClass = function () {
				var _p1 = direction;
				if (_p1.ctor === 'Left') {
					return 'fa fa-arrow-circle-o-left fa-2x';
				} else {
					return 'fa fa-arrow-circle-o-right fa-2x';
				}
			}();
			return A2(
				_rundis$elm_bootstrap$Bootstrap_Grid$col,
					...
					_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Matcher_Finder$class(arrowClass),
									_1: {ctor: '[]'}
								}
							}
						}),
				...
				{
					ctor: '::',
					_0: _user$project$ViewUtilities$faIcon(faClass),
					_1: {ctor: '[]'}
				});
		});
	var _p2 = _elm_lang$core$List$head(model.rightMatches);
	if (_p2.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('No Users To Look At');
	} else {
		var _p5 = _p2._0;
		var event = function () {
			var _p3 = model.userBeingViewed;
			if (_p3.ctor === 'Just') {
				return _user$project$Model$LookAwayFromUser;
			} else {
				return _user$project$Model$LookAtUser(_p5);
			}
		}();
		var caption = function () {
			var _p4 = model.userBeingViewed;
			if (_p4.ctor === 'Just') {
				return _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(_p4._0.description));
			} else {
				return _user$project$Matcher_Finder$showInfos(_p5);
			}
		}();
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Grid$row,
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Grid_Row$attrs(
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('align-items-center justify-content-center'),
						_1: {
							ctor: '::',
							_0: _user$project$Matcher_Finder$class(
								{
									ctor: '::',
									_0: _user$project$SharedStyles$FinderBody,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
			...
			{
				ctor: '::',
				_0: A2(arrow, model, _user$project$Model$Left),
				_1: {
					ctor: '::',
					_0: A2(
						_rundis$elm_bootstrap$Bootstrap_Grid$col,
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(_p5.profileName),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A3(
									...
									'figure',
									{
										...
										_1: {
											...
											_0: _user$project$Matcher_Finder$class(
												{
													ctor: '::',
													_0: _user$project$SharedStyles$FinderFigure,
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src(_p5.imgUrl),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('figure-img img-fluid rounded'),
													_1: {
														ctor: '::',
														_0: _user$project$Matcher_Finder$class(
															{
																ctor: '::',
																_0: _user$project$SharedStyles$FinderFace,
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
										...
										_1: {
											...
											_0: A3(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('figure-caption text-center'),
													_1: {
														ctor: '::',
														_0: _user$project$Matcher_Finder$class(
															{
																ctor: '::',
																_0: _user$project$SharedStyles$FinderInfo,
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
					...
					_1: {
						ctor: '::',
						_0: A2(arrow, model, _user$project$Model$Right),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Matcher_Finder$view = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Matcher_Finder$localProfile(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$View$view = function (model) {
	...
	switch (_p0.ctor) {
		case 'Login':
			return _user$project$Login$view;
		case 'MainMenu':
			return _user$project$MainMenu$view(model);
		case 'PreferencesRoot':
			return _user$project$Preferences_Root$view(model);
		case 'PreferencesShopping':
			return _user$project$Preferences_Shopping$view(model);
		case 'PreferencesSightseeing':
			return _user$project$Preferences_Sightseeing$view(model);
		default:
			return _user$project$Matcher_Finder$view(model);
	}
};

var _user$project$App$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Navbar$subscriptions, model.navbarState, _user$project$Model$NavbarMsg);
};
var _user$project$App$init = _user$project$DevSettings$devModel;
var _user$project$App$main = _elm_lang$html$Html$program(
	{init: _user$project$App$init, update: _user$project$Update$update, view: _user$project$View$view, subscriptions: _user$project$App$subscriptions})();
